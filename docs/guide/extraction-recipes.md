...
- The MCP-specific `json-rpc/handle-message` — your service has a different dispatch table.
...
- The MCP-specific `resources/read` JSON-RPC envelope — your protocol differs.
