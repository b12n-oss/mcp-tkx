...
| [Protocol versions](protocol-versions.md) | Version negotiation algorithm, what each of the 5 supported versions adds, breaking changes (JSON-RPC batching removed in 2025-06-18), backward-compat notes |
